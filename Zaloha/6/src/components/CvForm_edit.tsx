        ...
        <div className={styles.card}>
          ...
          <div className={styles.formButtons}>
            <button
              ...
              onClick={() => router.push(`/zaplaceno/${id}`)}
            >
        ...
        <div className={styles.card}>
          ...
          <div className={styles.addBox} style={{ flexDirection: "column", alignItems: "stretch" }}>
            ...
            <div style={{ margin: "1rem 0 0.5rem 0" }}>
              ...
              <b>Body (popis pracovní pozice): <HelpTooltip text="Vypište co byla vaše náplň práce, nebo vygenerujte pomocí AI" /></b>
              <button
                type="button"
                ...
                try {
                  const res = await fetch("/api/generate-exp-points", {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
                  ...
                  console.log("Odpověď z API /api/generate-exp-points:", json);
