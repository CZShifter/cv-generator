        ...
        <div className={styles.guideWrapper}>
            ...
            <div className={styles.guideStep}>
              ...
              <div className={styles.guideText}>
                ...
                <p>
                  V této části vyplňujete své dosažené vzdělání. Každý záznam by měl obsahovat <strong>dosažené vzdělání</strong>, <strong>název školy</strong>, <strong>obor</strong> a <strong>rok ukončení studia</strong>. Tyto údaje jsou zásadní pro celkovou důvěryhodnost životopisu.
                </p>
                <p>
                  Doporučujeme zadávat jednotlivé školy od <strong>nejnovější po nejstarší</strong>. První (nejvyšší) dosažené vzdělání by mělo být uvedeno jako první v seznamu – personalista tak hned vidí váš aktuální stav vzdělání.
                </p>
            ...
            <div className={styles.guideStep}>
              ...
              <div className={styles.guideText}>
                ...
                <p>
                  V části <strong>Jazykové znalosti</strong> uvádíte všechny jazyky, které ovládáte (včetně rodného). Pro každý jazyk vyberte také úroveň své znalosti.
                </p>
                <p>
                ...
                <blockquote>
                  <strong style={{ color: "#444"}}>Vysvětlení úrovní znalosti jazyka podle CEFR:</strong><br/>
                  <br/>
                  <strong style={{ color: "#444"}}>A1</strong> – začátečník<br/>
                  <strong style={{ color: "#444"}}>A2</strong> – mírně pokročilý<br/>
                  <strong style={{ color: "#444"}}>B1</strong> – středně pokročilý<br/>
                  <strong style={{ color: "#444"}}>B2</strong> – pokročilý<br/>
                  <strong style={{ color: "#444"}}>C1</strong> – velmi pokročilý<br/>
                  <strong style={{ color: "#444"}}>C2</strong> – téměř rodilý mluvčí<br/>
                  <strong style={{ color: "#444"}}>Rodilý mluvčí</strong> – jazyk používáte jako svůj hlavní a bez omezení
                </blockquote>
              </div>
            </div>
            ...
            <div className={styles.guideStep}>
              ...
              <div className={styles.guideText}>
                ...
                <p>
                  Zadat dovednosti lze dvěma způsoby: Buď je <strong>manuálně napíšete do textového pole</strong> a poté je přidáte stisknutím tlačítka <strong>„Přidat“</strong>, nebo jednoduše <strong>vyberete z nabídky nejčastějších dovedností</strong> – stačí kliknout na políčko s vybraným názvem dovednosti a automaticky se vám přidá do seznamu.
                </p>
                <p>
            ...
            <div className={styles.guideStep}>
              ...
              <div className={styles.guideText}>
                ...
                <p>
                  Ke každé pracovní zkušenosti můžete přidat <strong>konkrétní body</strong>, které popisují vaše hlavní úkoly, odpovědnosti, dosažené úspěchy nebo projekty. Každý bod zadáváte ručně a doporučujeme u každé pozice uvést <strong>ideálně 3–8 stručných bodů</strong>.  
                  Personalisté tak lépe pochopí, v čem jste v práci opravdu vynikali a jaký byl váš konkrétní přínos.
                </p>
                <p>
                ...
                <blockquote>
                  Každou pracovní pozici můžete kdykoliv upravit kliknutím na ikonu <FaEdit style={{ color: "#3d61d3", verticalAlign: "middle" }} /> („Upravit“), nebo zcela odstranit kliknutím na ikonu <FaTrash style={{ color: "#d7263d", verticalAlign: "middle" }} /> („Smazat“).  
                  Správné řazení a konkrétní popis každé zkušenosti vám výrazně zvýší šanci zaujmout personalistu už při prvním pohledu na životopis.
                </blockquote>
              </div>
            </div>
        </div>
