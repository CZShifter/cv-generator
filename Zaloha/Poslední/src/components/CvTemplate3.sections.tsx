...
export function getCvTemplate3Sections(data: CvData) {
  ...
  if (data.experience.length > 0) {
    right.push(
      <div className={styles.section} key="experience">
        <div className={styles["section-title"]}><MdOutlineWorkOutline />PRACOVNÍ ZKUŠENOSTI</div>
