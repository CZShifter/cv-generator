...
import { SITE_URL, OG_IMAGE, SITE_NAME, SITE_MAIL } from "../config/site";
...
const FAQ_ITEMS = [
  ...
  {
    question: "Je možné získat fakturu?",
    answer: "Ano, po úhradě se Vám spolu s životopisem vygeneruje i faktura ke stažení.",
  },
  {
      ...
      <div className={styles.contact_wrapper}>
        ...
        <div className={styles.left_wrapper}>
          ...
          <div className={styles.kontaktbox}>
            ...
            <p>Tomáš Tippl</p>
            <p>IČO: 88520510</p>
            <p>Ulice: Strnady 137</p>
            <p>Město: Jílovište 252 02</p>
