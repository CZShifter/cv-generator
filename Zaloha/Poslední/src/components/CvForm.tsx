    ...
    <div className={styles.price_card_wrapp}>
      <div className={styles.price_card} id="pay">
        <div className={styles.price_section}>
          <h2>89</h2>
          <p>*Cena za vytvoření životopisu</p>
        </div>
        ...
        <div className={styles.inputGroupAgree}>
          ...
          >
            ...
            />
            Souhlasím s <a href="/dokumenty/obchodni-podminky" target="_blank" rel="noopener noreferrer">obchodními podmínkami</a>
          </label>
        </div>
      </div>
      <button
      ...
      >
        {isProcessing ? "Zpracovávám..." : "Zaplatit (89Kč)"}
      </button>
    </div>
