    ...
    <section className={styles.AI}>
      <div className={styles.AIWrapper}>
        ...
        <div className={styles.AITitleWrapper}>
          ...
          <p>Díky integrované AI technologii ChatGPT můžete svůj životopis snadno vylepšovat přímo v editoru. Umělá inteligence za Vás vytvoří správnou formulaci textů a pomůže vytvořit profesionální CV rychle a bez náročného přemýšlení.</p>
        </div>          
      </div>
    </section>
  )
