    ...
    <section className={styles.Hook} id="zivotopis">
      <div className={styles.HookWrapper}>
        ...
        <div className={styles.HookTitleWrapper}>
          ...
          <p>Díky integrované umělé inteligenci Vám aplikace pomůže automaticky navrhnout silné body, profesní zkušenosti i motivační texty rychleji a lépe, než kdy dřív.</p>
