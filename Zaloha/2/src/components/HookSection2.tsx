    ...
    <section className={styles.Hook}>
      <div className={styles.HookWrapper}>
        <div className={styles.HookLeft}>
          <picture>
            <source srcSet="/img/cover1.webp" type="image/webp" />
            <source srcSet="/img/cover1.png" type="image/png" />
              <img
                src="/img/cover1.jpg"
            ...
            <picture>
              <source srcSet="/img/cover7.webp" type="image/webp" />
              <source srcSet="/img/cover7.png" type="image/png" />
              <img
              src="/img/cover7.jpg"
            ...
            <picture>
            <source srcSet="/img/cover8.webp" type="image/webp" />
            <source srcSet="/img/cover8.png" type="image/png" />
            <img
              src="/img/cover8.jpg"
