...
export const OG_IMAGE = `${SITE_URL}/img/og-cvgen.png`;
...
// Meta icony
export const FAVICON_URL_32 = "/img/favicon.png";
export const FAVICON_URL_192 = "/img/favicon-192.png";
export const APPLE_TOUCH_ICON_URL = "/img/apple-touch-icon.png";
