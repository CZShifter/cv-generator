  ...
  return (
    <section className={styles.narrative}>
      <div className={styles.container}>
        ...
        <p>
          <strong>Doporučujeme začít u životopisu</strong> – <a href="/preview"><strong>vytvořte si nejprve profesionální životopis</strong></a>, který bude tvořit pevný základ celé žádosti. Spolu s motivačním dopisem pak získáte kompletní a přesvědčivou prezentaci Vašich zkušeností i motivace.
        </p>
      </div>
    </section>
  );
