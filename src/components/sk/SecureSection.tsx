    ...
    <section className={styles.AI}>
      <div className={styles.SecureWrapper}>
        ...
        <div className={styles.SecureTitleWrapper}>
          ...
          <p>Na rozdiel od iných aplikácií si v našej <strong>nevytvárate žiadny účet</strong>. Bezpečnosť je u nás na prvom mieste a vaše osobné údaje nikdy nepredávame žiadnej tretej strane. <strong>Vaše dáta držíme iba 24 hodín</strong>, aby ste mohli pohodlne upravovať váš životopis.</p>
        </div>          
      </div>
    </section>
  )
