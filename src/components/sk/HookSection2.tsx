    ...
    <section className={styles.Hook} id="zivotopis">
      <div className={styles.HookWrapper}>
        <div className={styles.HookTitleWrapper}>
          ...
          <p><strong>Motivačný list</strong> je ideálnym doplnkom k štruktúrovanému životopisu. Pomáha lepšie vysvetliť, prečo sa o pozíciu uchádzate, a dáva príležitosť ukázať vašu motiváciu aj prínos pre firmu. S našou aplikáciou <strong>vytvoríte kvalitný motivačný list v priebehu niekoľkých minút</strong>, bez stresu a s istotou, že výsledok zodpovedá súčasným náborovým štandardom.</p>
