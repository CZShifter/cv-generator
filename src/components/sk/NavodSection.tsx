        ...
        <div className={styles.guideWrapper}>
            ...
            <div className={styles.guideStep}>
              ...
              <div className={styles.guideText}>
                ...
                <blockquote>
                  Všimnite si <strong>zelených prepínačov</strong> pri jednotlivých poliach – slúžia na zapnutie alebo vypnutie konkrétnej položky v životopise.<br />
            ...
            <div className={styles.guideStep}>
              ...
              <div className={styles.guideText}>
                ...
                <blockquote>
                  Každý záznam môžete kedykoľvek upraviť pomocou ikony <FaEdit style={{ color: "#11539e", verticalAlign: "middle" }} /> („Upraviť“), alebo úplne odstrániť kliknutím na ikonu <FaTrash style={{ color: "#d7263d", verticalAlign: "middle" }} /> („Vymazať“).
                </blockquote>
              </div>
            </div>
            {/* KROK 3 */}
            ...
            <div className={styles.guideStep}>
              ...
              <div className={styles.guideText}>
                ...
                <blockquote>
                  <strong style={{ color: "#444" }}>Vysvetlenie úrovní podľa CEFR:</strong><br />
                  <strong>A1</strong> – začiatočník<br />
                  <strong>A2</strong> – mierne pokročilý<br />
                  <strong>B1</strong> – stredne pokročilý<br />
                  <strong>B2</strong> – pokročilý<br />
                  <strong>C1</strong> – veľmi pokročilý<br />
                  <strong>C2</strong> – takmer ako rodený hovorca<br />
                  <strong>Rodený hovorca</strong> – jazyk používate bez obmedzení
                </blockquote>
              </div>
            </div>
            ...
            <div className={styles.guideStep}>
              ...
              <div className={styles.guideText}>
                ...
                <blockquote>
                  Každý záznam môžete kedykoľvek upraviť pomocou ikony <FaEdit style={{ color: "#11539e", verticalAlign: "middle" }} /> („Upraviť“), alebo úplne odstrániť kliknutím na ikonu <FaTrash style={{ color: "#d7263d", verticalAlign: "middle" }} /> („Odstrániť“). Úprava umožňuje rýchlo opravovať preklepy alebo dopĺňať informácie, mazanie zase slúži na odstránenie starých či nepotrebných údajov.
                </blockquote>
              </div>
            </div>
            ...
            <div className={styles.guideStep}>
              ...
              <div className={styles.guideText}>
                ...
                <blockquote>
                  Každú pracovnú pozíciu môžete kedykoľvek upraviť kliknutím na ikonu <FaEdit style={{ color: "#3d61d3", verticalAlign: "middle" }} /> („Upraviť“), alebo úplne odstrániť kliknutím na ikonu <FaTrash style={{ color: "#d7263d", verticalAlign: "middle" }} /> („Odstrániť“).  
                  Správne zoradenie a konkrétny popis každej skúsenosti vám výrazne zvýši šancu zaujať personalistu už pri prvom pohľade na životopis.
                </blockquote>
              </div>
            </div>
        </div>
