      ...
      {step === 2 && (
        <div className={styles.card}>
          ...
          <div className={styles.addBox}>
            ...
            <div className={styles.addBoxCol}>
              <label className={styles.inlineLabel} htmlFor="cert-year">Rok: <HelpTooltip text="Rok ukončenia kurzu" /></label>
              <input
                id="cert-year"
                className={`${styles.input} ${!data.showCertifications ? styles.disabled : ""}`}
                placeholder="Rok ukončenia"
        ...
        <div className={styles.card}>
          ...
          <div className={styles.addBox} style={{ flexDirection: "column", alignItems: "stretch" }}>
            ...
            <div style={{ margin: "1rem 0 0.5rem 0" }}>
              ...
              <strong>Body (popis pracovnej pozície):</strong> <HelpTooltip text="Napíšte, čo bola Vaša pracovná náplň, alebo vygenerujte pomocou AI."/>
              <button
                type="button"
    ...
    <div className={styles.price_card_wrapp}>
      <div className={styles.price_card} id="pay">
        ...
        <div className={styles.price_list}>
          ...
          <p>Životopis dostupný 24 h na úpravu</p>
        ...
        {showAgreeError && (
          <div className={styles.errorAgree}>
            Najprv musíte súhlasiť s obchodnými podmienkami.
          </div>
        )}
        ...
        <div className={styles.inputGroupAgree}>
          ...
          >
            ...
            />
            Súhlasím s <a href="/sk/dokumenty/obchodni-podminky" target="_blank" rel="noopener noreferrer">obchodními podmínkami</a>
          </label>
        </div>
      </div>
      <button
          ...
          onClick={async () => {
          trackGAEvent('click', 'payment', 'placeni_zivotopisu_sk');
          if (!agree) { setShowAgreeError(true); return; }

          try {
            setIsProcessing(true);
            const r = await fetch("/api/sk/create-payment", {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({
            ...
            if (j.redirectUrl && j.transId && j.refId && j.paymentToken) {
              // POZOR: cv_draft teď NEMAŽEME – smaže se až po úspěchu na /sk/po-platbe
      ...
      >
        {isProcessing ? "Spracovávam..." : `Zaplatiť (${PRICE_CV_SK}€)`}
      </button>
    </div>
