    ...
    <main className={styles.narrative}>
      <div className={styles.container}>
        <div className={styles.NarrativeRightWrapper}>
            <picture className={styles.NarrativeleftImg}>
              ...
              <img
                ...
                alt="Skupina ľudí sa pozerá do notebooku"
        ...
        <div className={styles.NarrativeLeftWrapper}>
          ...
          <p>Naša aplikácia ponúka riešenie, ktoré je premyslené do posledného detailu – od výberu typografie až po štruktúru jednotlivých sekcií. <strong>Všetko vychádza z reálnej praxe v oblasti HR</strong> nadnárodných korporácií a je navrhnuté tak, aby personalista v priebehu niekoľkých sekúnd získal jasnú predstavu o vašich schopnostiach, skúsenostiach a potenciáli. Váš životopis tak bude spĺňať nároky profesionálov z oblasti HR.</p>
          <p>Aplikácia <strong>zjednodušuje celý proces</strong>, bez toho, aby pritom znižovala kvalitu. Váš čas je cenný a správne štruktúrovaný životopis môže byť presne to, čo ho premení na skutočnú príležitosť.</p>
