    ...
    <section className={styles.Hero}>
      ...
      <div className={styles.HeroWrapper}>
        ...
        <div className={styles.HeroTitleWrapper}>
          <p>Najrýchlejšia cesta na pohovor</p>
<h1><strong>Tvorba <span>životopisu</span></strong> <br></br><span>jednoducho</span>&nbsp;a rýchlo&nbsp;</h1>
<p>Zaujmite personalistu moderným štruktúrovaným životopisom ešte skôr, než dočíta prvú vetu. Vďaka umelej inteligencii vytvoríte profesionálny životopis bez stresu už za pár minút!</p>
          <div className={styles.LinkWrapper}>
            <div>
              <Link href="/sk/preview" className={styles.cta}>Začať&nbsp;hneď</Link>
            </div>
