...
import { SELLER_COMPANY, SELLER_IC, SELLER_ADDRESS, SELLER_ADDRESS_CITY, SITE_MAIL_SK } from "@/config/site";
        ...
        <div className={styles.contact_wrapper}>
          ...
          <div className={styles.left_wrapper}>
            ...
            <div className={styles.oNas}>
              ...
              <p>Veríme, že vytvoriť štruktúrovaný životopis by malo byť jednoduché, rýchle a dostupné pre každého.</p>
            ...
            <div className={styles.kontaktbox}>
              ...
              <p>E-mail: <a href={`mailto:${SITE_MAIL_SK}`} className={styles.email} onClick={() => trackGAEvent('click', 'contact', 'email_click_sk')}>{SITE_MAIL_SK}</a></p>
            </div>
          </div>
          {/* FAQ akordeon */}
