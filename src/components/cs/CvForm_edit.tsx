      ...
      {step === 0 && (
        <div className={styles.card}>
          ...
          <div className={styles.rowGrid}>
            ...
            <div className={styles.inputGroup}>
              ...
              <input
                ...
                placeholder="Např. www.mujweb.cz"
              />
            </div>
            <div className={styles.inputGroup}>
          ...
          <div className={styles.sectionSwitch}>
            <div className={styles.labelRow}>
              <label>O mně: <HelpTooltip text="Napište o sobě krátký text, který Vás vystihne" /></label>
              <label className={styles.switchWrap} style={{ cursor: "pointer" }}>
            ...
            <textarea rows={7}
              ...
              placeholder="Napište o sobě..."
            />
          </div>
          <div className={styles.sectionSwitch}>
            <div className={styles.labelRow}>
              <label>Přidat fotku: <HelpTooltip text="Fotka musí mít maximální rozměr 1024 x 1024 px a velikost 1 MB" /></label>
              <label className={styles.switchWrap} style={{ cursor: "pointer" }}>
          ...
          <div className={styles.formButtons}>
            <button
              ...
              onClick={() => router.push(`/cs/zaplaceno/${id}`)}
            >
              Zpět na stažení životopisu
            </button>
        ...
        <div className={styles.card}>
          ...
          <div className={styles.addBox} style={{ flexDirection: "column", alignItems: "stretch" }}>
            ...
            <div style={{ margin: "1rem 0 0.5rem 0" }}>
              ...
              <b>Popis pracovní pozice: <HelpTooltip text="Vypište co byla vaše náplň práce, nebo vygenerujte pomocí AI" /></b>
              <button
                type="button"
          ...
          <div className={styles.formButtons}>
            ...
            >
              {isProcessing ? "Ukládám..." : isEditMode ? "Uložit změny" : "Dokončit"}
            </button>
          </div>
        </div>
      )}
      {expiredModalOpen && (
        <div className={styles.modalOverlay}>
          <div className={styles.modalContent}>
            <h2>Platnost 24h vypršela!</h2>
            <p>Vypršela doba 24h pro úpravu. Pokud chcete životopis změnit, musíte jej znovu zakoupit.</p>
            <button className={styles.save} onClick={() => setExpiredModalOpen(false)}>Zavřít</button>
          </div>
        </div>
      )}
    </div>
