    ...
    <section className={styles.guideSection}>
      <Head>
        ...
        <div className={styles.guideWrapper}>
            ...
            <p className={styles.intro}>Nejste si jistí jak správně vyplnit svůj životopis? Projděte si jednoduchý návod krok za krokem</p>
            {/* KROK 1 */}
            <div className={styles.guideStep}>
              ...
              <div className={styles.guideTextWrapper}>
                ...
                <blockquote>
                    <p>Všimněte si <strong>zelených přepínačů</strong> u jednotlivých polí – slouží k zapnutí nebo vypnutí konkrétní položky v životopise.</p>
                    <p>Pokud je přepínač aktivní <strong>(zelený)</strong>, tato informace bude zahrnuta ve výsledném CV.</p>
                    <p>Pokud jej vypnete <strong>(červený)</strong>, údaj se do životopisu nedostane.</p>
