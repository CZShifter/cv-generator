    ...
    <main className={styles.narrative}>
      <div className={styles.container}>
        <div className={styles.NarrativeLeftWrapper}>
          ...
          <p>A pokud potřebujete i <Link href='/cs/motivacni-dopis'>motivační dopis</Link>, aplikace nabízí jeho generování <strong>zcela zdarma</strong>. Jednoduše a bez závazků.</p>
        </div>
