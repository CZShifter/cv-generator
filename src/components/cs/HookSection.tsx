    ...
    <section className={styles.Hook} id="zivotopis">
      <div className={styles.HookWrapper}>
        <div className={styles.HookTitleWrapper}>
          ...
          <p>Vytvořit <Link href="/cs/profese">profesionální životopis</Link> nemusí být složité. Mnoho uchazečů se denně potýká s nepraktickými editory, nepřehlednými šablonami a nutností registrace do služeb, které slibují víc, než dodají. Naše aplikace vznikla jako odpověď na tyto problémy.</p>
