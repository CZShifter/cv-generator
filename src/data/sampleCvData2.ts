...
cvtemplate: {
  ...
  experience: [
    {
      ...
      points: [
        ...
        "Analýza tržních trendů a konkurence pro identifikaci růstových oblastí.",
      ],
    },
    {
  ...
  certifications: [
    // Tyto certifikace nejsou pro prodavače relevantní, ale můžete přidat například "Certifikát pro obsluhu pokladního systému"
  ],
  language: [
    { name: "Český jazyk", level: "Rodilý mluvčí" },
