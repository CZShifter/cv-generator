...
<div class="two-thirds image-left">
  <div class="text">
    ...
    <ul>
      ...
      <li><strong>Certifikace / Kurzy</strong> – relevantní a platné.</li>
      <li><strong>Jazyky</strong> – úroveň (A1–C2) nebo popisně (Znalost na úrovni B2).</li>
    </ul>
  </div>
  <div class="media">
    <picture>
...
## 3. Pracovní zkušenosti – jak je psát správně

<p>U každé role uveďte <strong>název pozice</strong>, <strong>firmu</strong>, <strong>období</strong> (MM/RRRR – MM/RRRR), <strong>lokalitu</strong> a 3–6 odrážek s výsledky. Dodržujte <strong>logiku dopadu</strong>: co jste změnili, o kolik, komu to pomohlo.</p>

<ul>
  <li><strong>Vedl</strong> jsem implementaci <strong>CRM Salesforce</strong> pro 80 uživatelů; <strong>zkrácení</strong> doby obchodního cyklu o <strong>18 %</strong>.</li>
  <li><strong>Optimalizoval</strong> jsem proces zpracování objednávek; snížení <strong>chybovosti</strong> o <strong>35 %</strong> a úspora <strong>120 hodin</strong> měsíčně.</li>
...
<div class="two-thirds image-left">
  <div class="text">
    <p>Rozdělte dovednosti na <strong>hard skills</strong> a <strong>soft skills</strong>. U hard skills zvažte i <strong>úroveň</strong> (základy / pokročilý / expert):</p>
    <ul>
...
## 5. Vzdělání, certifikace a projekty

<p>U vzdělání stačí název školy, obor a roky. Pokud jste na začátku kariéry, zvýrazněte <strong>projekty</strong>, <strong>práce</strong> či <strong>stáže</strong>. U certifikací uvádějte <strong>platnost</strong> (pokud expirují) a <strong>ID</strong> či <strong>URL</strong> pro ověření.</p>

<ul>
  <li><strong>VŠE</strong> – Mezinárodní obchod (2018–2021)</li>
  <li><strong>Google Data Analytics Certificate</strong> (2024)</li>
  <li><strong>Projekt:</strong> Dashboard v Power BI pro e‑shop – analýza košíku, churn a LTV.</li>
</ul>

---

## 6. Jak upravit CV pro konkrétní pozici
...
### Kariérní změna
<p>Zdůrazněte <strong>přenositelné dovednosti</strong> (řízení projektů, komunikace, práce s daty) a <strong>projekty</strong>, které dokazují schopnost v novém oboru. Přidejte <strong>kurzy</strong> a <strong>certifikace</strong>.</p>

### Mezery v životopise
<p>Krátce a pravdivě vysvětlete (<strong>rodičovská</strong>, <strong>studium</strong>, <strong>péče o blízké</strong>, <strong>cestování</strong>), doplňte co jste se naučili (kurzy, projekty). Důležitá je <strong>relevance</strong> k pozici.</p>

### Absolventi / juniorní uchazeči
<p>Dejte nahoru <strong>projekty</strong>, <strong>stáže</strong> a <strong>kompetence</strong>. Místo slabých pracovních zkušeností ukažte <strong>výsledky</strong> z praxí, týmových projektů, hackathonů, soutěží.</p>
...
<div class="two-thirds image-left">
  <div class="text">
    <ul>
      <li><strong>Vágní formulace</strong> – používejte akční slovesa a čísla.</li>
      <li><strong>Nekonzistence</strong> – jiná velikost písma, mezery, odsazení.</li>
      <li><strong>Chybějící klíčová slova</strong> – CV neprojde <strong>ATS</strong>.</li>
...
## 9. Praktický postup krok za krokem

<ol>
  <li><strong>Shromážděte podklady</strong> – projekty, metriky, ocenění, reference, odkazy.</li>
  <li><strong>Vyberte šablonu</strong> – čitelnou, konzervativní, s jasnou hierarchií.</li>
  <li><strong>Napište profil</strong> – 2–4 věty s hodnotou a cílem.</li>
  <li><strong>Sepište zkušenosti</strong> – max. 6 odrážek na roli, metoda <strong>STAR/CAR</strong>.</li>
  <li><strong>Přidejte dovednosti</strong> – relevantní, seskupené, případně s úrovní.</li>
...
## 10. Kontrolní seznam před odesláním

<ul>
  <li><strong>Aktuální data</strong> – telefon, e‑mail, odkazy, pozice.</li>
  <li><strong>Metriky a dopad</strong> – je v každé roli alespoň 1–2 <strong>číselné výsledky</strong>?</li>
  <li><strong>Klíčová slova</strong> – sedí s inzerátem (ATS)?</li>
  <li><strong>Design a čitelnost</strong> – 1–2 strany, konzistentní typografie, dostatek bílého místa.</li>
</ul>
