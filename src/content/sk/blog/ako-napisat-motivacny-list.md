...
<div class="two-thirds image-left">
  ...
  <div class="media">
    <picture>
      ...
      <img src="/img/blog/motivacni1.jpg" alt="Personalistka číta motivačný list" loading="lazy" decoding="async" />
    </picture>
  </div>
</div>
...
<p>Držte sa osvedčenej kostry na <strong>3–4 odseky</strong> a maximálne jednu stranu A4:</p>

<ol>
  <li><strong>Úvod</strong> – prečo píšete, o akú pozíciu sa uchádzate a kde ste sa o nej dozvedeli.</li>
  <li><strong>Prečo vy?</strong> – prepojte vaše skúsenosti, zručnosti a výsledky s požiadavkami firmy.</li>
  <li><strong>Prečo oni?</strong> – ukážte, že poznáte firmu, jej projekty a hodnoty, a prečo vás oslovili.</li>
  <li><strong>Záver</strong> – poďakujte, vyjadrite ochotu k osobnému stretnutiu, pridajte kontakt.</li>
</ol>
...
<div class="two-thirds image-right">
  ...
  <div class="media">
    <picture>
      ...
      <img src="/img/blog/motivacni3.jpg" alt="Písanie motivačného listu" loading="lazy" decoding="async" />
    </picture>
  </div>
</div>
...
<ul>
  <li><strong>Personalizácia</strong> – píšte konkrétne meno personalistu, ak ho poznáte.</li>
...
<div class="two-thirds image-left">
  <div class="text">
    <ul>
      <li>Používanie <strong>všeobecných fráz</strong> bez dôkazov.</li>
      <li>Opakovanie celého životopisu – list má dopĺňať, nie duplikovať.</li>
  ...
  <div class="media">
    <picture>
      ...
      <img src="/img/blog/motivacni2.jpg" alt="Chyby v motivačnom liste" loading="lazy" decoding="async" />
    </picture>
  </div>
</div>
