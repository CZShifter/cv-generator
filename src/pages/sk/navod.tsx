...
export default function NavodPage() {
  return ( 
      <>
      <Head>
        <title>{`Návod – Jak vyplnit online životopis krok za krokem | ${SITE_NAME_SK}`}</title>
        ...
        {/* OpenGraph */}
        <meta property="og:title" content={`Návod – Jak vyplnit online životopis krok za krokem | ${SITE_NAME_SK}`}/>
        ...
        <meta property="og:url" content={`${SITE_URL_SK}/navod`} />
        <meta property="og:type" content="article" />
        <meta property="og:locale" content="sk_SK" />
        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`Návod – Jak vyplnit online životopis krok za krokem | ${SITE_NAME_SK}`}/>
        ...
        <link rel="alternate" href={`${SITE_URL_SK}/sk/navod`} hrefLang="sk" />
        <link rel="alternate" href={`${SITE_URL_SK}/cs/navod`} hrefLang="cs" />
